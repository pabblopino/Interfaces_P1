$(document).ready(function() { // Todo nuestro código va aquí dentro
    ...
    $('#btnGuardar').on('click', function(){
        ...
        const nombre = $('#nombre').val().trim(); // Cogemos el valor y quitamos los espacios del principio y el final
        ...
        const imagen_input = $('#imagen')[0]; // Obtiene el elemento HTML del input

        const lista_de_archivos = imagen_input.files;

        if (lista_de_archivos.length === 0) {
            ...
            const nombre_archivo = imagen_input.files[0].name;
